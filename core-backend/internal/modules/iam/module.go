...
var Module = fx.Module("iam",
	...
	fx.Provide(service.NewBusinessProfileImageService),
	...
	fx.Provide(handler.NewBusinessProfileImageHandler),
	...
	fx.Invoke(func(api huma.API, authHandler *handler.AuthHandler, adminHandler *handler.AdminHandler,
		...
		routes.RegisterRoutes(api, routes.RouteDependencies{
			...
			BusinessProfileImageHandler: businessProfileImageHandler,
